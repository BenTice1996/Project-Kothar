...
if __name__ == "__main__":
    ...
    metadata_path = "#add your file path here"  # CSV with 'opinion_text' column
    output_dir = "#add your file path here"     # Output directory for results
    data_dir = "#add your file path here"       # Where tokenized data will be saved

    topic_range = [10, 20, 30, 40]               # LDA topic counts to test
    alpha_vals = ['symmetric', 'asymmetric', 0.01, 0.1, 0.5]  # α priors to test
    beta_vals = ['symmetric', 0.01, 0.1, 0.5]    # β priors (a.k.a eta) to test
    passes = 10                                  # LDA training iterations
    top_n_terms = 10                             # Top terms to describe each cluster
    similarity_threshold = 0.7                   # Cosine sim threshold for clustering
        ...
        for alpha in alpha_vals:
            for beta in beta_vals:
                ...
                coherence_model = CoherenceModel(
                    ...
                    coherence='c_v',
                    processes=1  # Windows compatibility
                )
    ...
    # === CLUSTER TOPICS USING COSINE SIMILARITY === #
    ...
    # Build cluster mapping: cluster_id → list of topic_ids
    ...
    # Ensure compatibility when saving to JSON
    ...
    # === Score Document-Cluster Relevance === #
    ...
    # === Merge Metadata and Annotate with Cluster Terms === #
    ...
    # Create summary string for top 3 clusters per doc
